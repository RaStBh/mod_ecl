 ...
 * @file
 *
 * @brief struct process_rec: A structure that represents one process.
 *
 * @details
 *
 * [process_rec Struct Reference](https://ci.apache.org/projects/httpd/trunk/doxygen/structprocess__rec.html)
 *
 * [http.h Source Code](https://ci.apache.org/projects/httpd/trunk/doxygen/httpd_8h_source.html)
 */
